...
public class budget2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Transportation will probably be around $200 per month for subway and uber/taxi charges.");
        ...
        if (food.equals("cook")) {
            groceries = 600.0;
            System.out.println("You will probably spend around $400 per month on groceries and $200 for eating out.");
        } else {
            groceries = 700.0;
            System.out.println("You will probably spend around $400 per month on eating out and $300 on groceries .");
        }
        ...
        System.out.println("So far with these essential expenses, you are spending around $"
                ...
                + (post_tax_salary / 12 - (rent + groceries + student_loans)) + " excess money per month.");
        ...
        System.out.println("Let's budget $100 for miscellaneous things like toilet paper, soap, facewash, etc.");
        ...
        System.out.println("Which will leave you with around $"
                + (post_tax_salary / 12 - (rent + groceries + student_loans + insurance + miscellaneous))
                + " per month.");
    }
